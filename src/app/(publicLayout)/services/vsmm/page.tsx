          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-4">
                <button className="px-8 py-4 bg-[#6efd0b] text-gray-900 rounded-md font-bold hover:bg-[#4fd100] transition-all duration-300 transform hover:scale-105 shadow-lg shadow-[#6efd0b]/25 flex items-center gap-2">
                  <Monitor size={18} />
