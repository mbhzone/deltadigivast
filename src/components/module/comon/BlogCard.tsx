...
export default function BlogCard({ blog }: Props) {
  ...
  return (
    <Link
      href={`/blog/${blog.id}`}
      className="group block  rounded-md shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-200 dark:border-gray-800 hover:-translate-y-1"
    >
